Shader "Unlit/Wireframe"
{
    Properties
    {
        ...
        _WireframeFrontColour("Wireframe front colour", color) = (0.0, 0.0, 1.0, 1.0)
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            fixed4 frag(g2f i) : SV_Target
            {
                ...
                float3 aliased = smoothstep(float3(0.0, 0.0, 0.0), unitWidth * 2, i.barycentric);
        ...
        Pass
        {
            ...
            fixed4 frag(g2f i) : SV_Target
            {
                ...
                float3 aliased = smoothstep(float3(0.0, 0.0, 0.0), unitWidth * 2, i.barycentric);
                //float3 aliased = smoothstep(float3(0.0, 0.0, 0.0), float3(1.0, 1.0, 1.0), i.barycentric);
                // Use the coordinate closest to the edge.
                float alpha = 1 - min(aliased.x, min(aliased.y, aliased.z));
